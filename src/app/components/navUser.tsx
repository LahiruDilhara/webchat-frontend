...
const NavUser = () => {
    ...
    return (
        <div className="flex flex-row items-center gap-sm cursor-pointer relative h-full brightness-75 bg-primary px-md z-[1001]" onClick={() => setProfile(!profile)} ref={menuRef}>
