...
const HomePage = () => {
    return (
        <div className="w-full h-full grid grid-rows-[1fr_1fr_7fr] gap-sm py-md">
            ...
            <div className="w-full flex flex-row gap-md overflow-x-auto">
                <div className="flex flex-col justify-center items-center text-center">
                    <div className="shrink-0 size-2xl flex justify-center items-center border-2 border-primary rounded-full">
                        <Plus size={16}></Plus>
                    </div>
            ...
            <div className="flex flex-col min-h-0">
                <h1 className="text-h3 pt-md pb-sm">Rooms</h1>
