        ...
        <>
            ...
            <div className="fixed inset-0 z-100 flex justify-center items-center h-screen w-screen" onClick={onClose}>
                <div className={`opacity-100 flex justify-center items-center ${className}`} onClick={(e) => e.stopPropagation()}>
                    <div className="h-full w-full overflow-hidden bg-card-bg grid grid-rows-[1fr_20fr] md:p-lg md:gap-sm sm:gap-sm sm:rounded-xl p-md">
                        <div className=" w-full flex items-center justify-between px-md py-sm bg-background sm:rounded-xl">
